<script>
    ...
    export let tabs = [
        ...
        { name: "Blog", link: "https://roescen.blogspot.com/" },
        // { name: "Contact", link: "" },
        // {name: '', link: ''},
    ];
</script>
...
<header
    class={"sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border-b border-solid " +
        (y > 0
            ? " py-4 bg-orange-800 border-orange-950"
            : " py-6 bg-transparent border-transparent")}
>
    <h1 class="font-medium">
        <b class="font-bold poppins">Roescen Abie</b> <span class="font-bold poppins">Pajaro</span>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        {#each tabs as tab, index}
            <a
                href={tab.link}
                class="duration-200 hover:text-orange-600"
